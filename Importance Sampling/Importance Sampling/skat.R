...
DIST<-k2dM(K,direction = "k2d",method="exp",scale = 2) #theta = 0.5
...
legend("topright",legend = c("Y binaire", "Y continue"), fill = c("blue","black"))

plot(tobs,pvalueskatB,col="blue",type="l")
lines(tobs,pvalueskatC,col="black",type='l')
legend("topright",legend = c("Y binaire", "Y continue"), fill = c("blue","black"))

print(paste0("Pvalue SKAt binaire = ", skat1))
print(paste0("Pvalue SKAt continu = ", skat2))
